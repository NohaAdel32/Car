      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            <img src="{{asset('uploads/'.$car->image)}}" alt="{{$car->title}}" class="img-fluid p-3 mb-5 bg-white rounded">
            ...
            <div class="pt-5">
              <p>Category:  <a href="#">{{ $car->category->category }}</a></p>
            </div>
          ...
          @foreach($category as $cat)
                <li><a href="#">{{$cat->category}} <span>({{ $cat->cars->count() }})</span></a></li>
                @endforeach
              </div>
            </div>
            <div class="sidebar-box">
